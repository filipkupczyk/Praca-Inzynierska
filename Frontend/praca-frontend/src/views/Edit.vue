                ...
                <div class="tile-text rounded-4">
                  <form @submit.prevent="handleSubmit">
                      ...
                      <div style="text-align: center;">
                        <button type="submit" class="btn text-white text-decoration-none bg-primary rounded-4 custom-button">Wprowadź zmiany</button>
                      </div>
                  </form>
                </div>
                <div class="tile rounded-4">
                    <div
                    class="drop-area"
...
<script setup>
    ...
    function checkImage() {
            if (post.value.image !== null) {
                currentBackground.value = `url(${post.value.image})`
            }
        }
    ...
    async function redirect(){
        await router.push({ path: '/myposts' });
